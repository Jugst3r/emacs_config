...
before packages are loaded."
  ...
  ;; anod are python files
  (add-to-list 'auto-mode-alist '("\\.anod$" . python-mode))
  ;; Custom key chords
  (key-chord-mode 1)
  (key-chord-define-global "uu" 'undo-tree-visualize)
  ;; Enable dumb jump by if no better option (such as lsp)
  ...
  (setq lsp-clients-angular-language-server-command
        '("node"
          "/home/meyraud/.nvm/versions/node/v14.16.0/lib/node_modules/@angular/language-server" "-v"
          "--ngProbeLocations"
          "/home/meyraud/.nvm/versions/node/v14.16.0/lib/node_modules"
          "--tsProbeLocations"
          "/home/meyraud/.nvm/versions/node/v14.16.0/lib/node_modules"
          "--stdio"))
  ...
  (require 'lsp-mode)
  (lsp-register-client
   (make-lsp-client :new-connection (lsp-tramp-connection "/home/eyraud/lsp/Microsoft.Python.LanguageServer")
